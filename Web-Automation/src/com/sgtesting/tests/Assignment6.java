...
public static WebDriver oBrowser=null;
	public static void main(String[] args) 
	{
					...
					public static void createproject1()
					{
						try
						{
							...
							oBrowser.findElement(By.name("projectDescriptionField")).sendKeys("this is project1");
					...
					public static void modifyproject1()
					{
						try
						{
							...
							oBrowser.findElement(By.xpath("//*[@id=\'ext-gen115\']/div[30]/div[2]/div")).click();
							Thread.sleep(5000);
						}catch(Exception e)
						{
							e.printStackTrace();
